...
export function Header() {
    ...
    return (
        <header className="container border-b-slate-900 border-solid mx-auto flex justify-between  items-center p-5 relative">
            <div>
                <Link href='/'>
            ...
            <div className="flex items-center gap-5">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button onClick={() => setmenuCheckout(true)}>
            ...
            {
                menuCheckout && (
                    <div className="absolute w-[300px]  top-20 rounded-lg shadow-xl right-0 bg-[#f6f6f6] z-10">
